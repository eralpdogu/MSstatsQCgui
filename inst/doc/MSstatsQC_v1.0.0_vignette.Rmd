...
<img src="/Users/ed/GitHub/MSstatsQC/vignettes/1.input_example.png" width="500">
...
<img src="/Users/ed/GitHub/MSstatsQC/vignettes/2.options_example.png" width="500">
...
```{r, eval=FALSE}
# Retention time >> mean is 34.5 and standard deviation is 1.0
XmRPlots(S9Site54, "LVNELTEFAK", metric = "BestRetentionTime", type="mean", selectMean = 34.5, selectSD = 1)
```
...
XmRPlots(S9Site54, "LVNELTEFAK", metric = "BestRetentionTime", type="mean", L = 1, U = 20)
XmRPlots(S9Site54, "LVNELTEFAK", metric = "TotalArea", type="mean", L = 1, U = 20)
```
...
```{r, eval=FALSE}
# Retention time >> first 20 observations are used as a guide set
XmRPlots(S9Site54, "LVNELTEFAK", metric = "BestRetentionTime", type="dispersion", L = 1, U = 20)
XmRPlots(S9Site54, "LVNELTEFAK", metric = "TotalArea", type="dispersion", L = 1, U = 20)
```
...
```{r, eval=FALSE}
# Retention time >> first 20 observations are used as a guide set
CUSUMPlots(S9Site54, "LVNELTEFAK", metric = "BestRetentionTime", type="mean", L=1, U=20, ytitle="CUSUMm")
CUSUMPlots(S9Site54, "LVNELTEFAK", metric = "TotalArea", type="mean", L=1, U=20, ytitle="CUSUMm")
CUSUMPlots(S9Site54, "LVNELTEFAK", metric = "BestRetentionTime", type="dispersion", L=1, U=20, ytitle="CUSUMv")
CUSUMPlots(S9Site54, "LVNELTEFAK", metric = "TotalArea", type="dispersion", L=1, U=20, ytitle="CUSUMv")
```
...
<img src="/Users/ed/GitHub/MSstatsQC/vignettes/3.XmRChartTAA.png" width="500">

<img src="/Users/ed/GitHub/MSstatsQC/vignettes/4.CUSUMforTAA.png" width="500">
...
```{r, eval=FALSE}
# Retention time >> first 20 observations are used as a guide set
XmRPlots(S9Site54, "YSTDVSVDEVK", metric = "BestRetentionTime", type="mean", L = 1, U = 20)
ChangePointEstimator(S9Site54, "YSTDVSVDEVK", metric = "BestRetentionTime", type="dispersion", L = 1, U = 20)
```

### Tip for Shiny users:

<img src="/Users/ed/GitHub/MSstatsQC/vignettes/5.CPforTAA.png" width="500">
...
<img src="/Users/ed/GitHub/MSstatsQC/vignettes/6.RiverRadar.png" width="500">
...
<img src="/Users/ed/GitHub/MSstatsQC/vignettes/7.DecisionInput.png" width="500">
<img src="/Users/ed/GitHub/MSstatsQC/vignettes/8.Decisionmaps.png" width="500">
